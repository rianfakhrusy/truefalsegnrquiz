 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_truefalsegnrquiz_question extends question_graded_automatically {
    public $rightanswer;
    public $truefeedback;
    ...
    public function summarise_response(array $response) {
        if (!array_key_exists('answer', $response)) {
            ...
            return get_string('true', 'qtype_truefalsegnrquiz');
        } else {
            return get_string('false', 'qtype_truefalsegnrquiz');
        }
    }
    ...
    public function classify_response(array $response) {
        ...
        if ($response['answer']) {
            return array($this->id => new question_classified_response(1,
                    get_string('true', 'qtype_truefalsegnrquiz'), $fraction));
        } else {
            return array($this->id => new question_classified_response(0,
                    get_string('false', 'qtype_truefalsegnrquiz'), $fraction));
        }
    }
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseselectananswer', 'qtype_truefalsegnrquiz');
    }
