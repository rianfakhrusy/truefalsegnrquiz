 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_truefalsegnrquiz_renderer extends qtype_renderer {
    public function formulation_and_controls(question_attempt $qa,
        ...
        $radiotrue = html_writer::empty_tag('input', $trueattributes) .
                html_writer::tag('label', get_string('true', 'qtype_truefalsegnrquiz'),
                array('for' => $trueattributes['id'], 'class' => 'm-l-1'));
        $radiofalse = html_writer::empty_tag('input', $falseattributes) .
                html_writer::tag('label', get_string('false', 'qtype_truefalsegnrquiz'),
        ...
        $result .= html_writer::tag('div', get_string('selectone', 'qtype_truefalsegnrquiz'),
                array('class' => 'prompt'));
    ...
    public function correct_response(question_attempt $qa) {
        ...
        if ($question->rightanswer) {
            return get_string('correctanswertrue', 'qtype_truefalsegnrquiz');
        } else {
            return get_string('correctanswerfalse', 'qtype_truefalsegnrquiz');
        }
    }
}
