...
/**
 * Test helpers for the truefalsegnrquiz question type.
 *
 * @package    qtype
...
/**
 * Test helper class for the truefalsegnrquiz question type.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_truefalsegnrquiz_test_helper extends question_test_helper {
    public function get_test_questions() {
        return array('true', 'false');
    }

    /**
     * Makes a truefalsegnrquiz question with correct answer true.
     * @return qtype_truefalsegnrquiz_question
     */
    public function make_truefalsegnrquiz_question_true() {
        question_bank::load_question_definition_classes('truefalsegnrquiz');
        $tf = new qtype_truefalsegnrquiz_question();
        ...
        $tf->penalty = 1;
        $tf->qtype = question_bank::get_qtype('truefalsegnrquiz');
    ...
    public function get_truefalsegnrquiz_question_form_data_true() {
    ...
    function get_truefalsegnrquiz_question_data_true() {
    ...
    /**
     * Makes a truefalsegnrquiz question with correct answer false.
     * @return qtype_truefalsegnrquiz_question
     */
    public function make_truefalsegnrquiz_question_false() {
        question_bank::load_question_definition_classes('truefalsegnrquiz');
        $tf = new qtype_truefalsegnrquiz_question();
        test_question_maker::initialise_a_question($tf);
        $tf->name = 'True/false question';
